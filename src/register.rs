    ...
    I2C: I2c,
{
    ...
    /// success.
    fn select_register_page(&mut self, reg: impl Into<Register>) -> Result<u8, Error<I2C::Error>> {
        match reg.into() {
    ...
    pub fn read_reg(&mut self, reg: impl Into<Register>) -> Result<u8, Error<I2C::Error>> {
